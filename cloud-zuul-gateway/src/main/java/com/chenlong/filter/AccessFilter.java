...
public class AccessFilter extends ZuulFilter {
    ...
    public Object run() {
        ...
        //ServletDetectionFilter 判断
        log.info("isDisptecherServletRequest:{}", RequestUtils.isDispatcherServletRequest());
        log.info("isZuulServletRequest:{}",RequestUtils.isZuulServletRequest());
